<template>
  ...
  <!-- Navigation -->
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">BRIDE OF CHRIST</a>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="../assets/img/bryan.png" alt="">
        <!-- Masthead Heading -->
        <h1 class="masthead-heading text-uppercase mb-0">Bryan Lim</h1>
        ...
        <!-- Masthead Subheading -->
        <p class="masthead-subheading font-weight-light mb-0">Software Engineer - Full Stack Engineer - Networker</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 m-auto">
            <p class="lead">Bryan is a Full Stac  k Engineer with a demonstrated history of working in the IT industry. Skilled in Python, Flask, Django, VueJS, AngularJS, Ionic, DevOps, AWS Services, Google Cloud Platform, Bug Tracking, JavaScript, Databases, Software Testing, and C# .Net. Strong engineering professional with a Bachelor's degree focused in Information Technology.</p>
          </div>
        </div>

        <!-- About Section Button -->
        <div class="text-center mt-4">
          <a class="btn btn-xl btn-outline-light" href="https://drive.google.com/open?id=1cqor4DlAIMkYecw7B_a20cluI9_MaEW4NDSo0J_fQe0">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            <p class="lead mb-0">Camarin Caloocan 
              <br>City, Philippines</p>
          </div>

          <!-- Footer Social Icons -->
          <div class="col-lg-4 mb-5 mb-lg-0">
            <h4 class="text-uppercase mb-4">Around the Web</h4>
            <a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/NEW.CLAUDE">
              <i class="fab fa-fw fa-facebook-f"></i>
            </a>
            <a class="btn btn-outline-light btn-social mx-1" href="#">
              <i class="fab fa-fw fa-twitter"></i>
            </a>
            <a class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/in/bryan-lim-3749b714a/">
    ...
    <section class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; Bryan Lim 2019</small>
      </div>
    </section>
